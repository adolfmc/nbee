...
nohup java -jar -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m -Xms128m -Xmx256m -Xmn180m -Xss256k -XX:SurvivorRatio=8 -XX:+UseConcMarkSweepGC appot-0.2.0.jar & 
java -jar -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m -Xms128m -Xmx256m -Xmn180m -Xss256k -XX:SurvivorRatio=8 -XX:+UseConcMarkSweepGC appot-0.2.0.jar


nohup java -jar -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m -Xms128m -Xmx256m -Xmn180m -Xss256k -XX:SurvivorRatio=8 -XX:+UseConcMarkSweepGC nbee-0.2.0.jar & 
 java -jar -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m -Xms128m -Xmx256m -Xmn180m -Xss256k -XX:SurvivorRatio=8 -XX:+UseConcMarkSweepGC nbee-0.2.0.jar
...
docker run -d -p 8016:80 --name nginx-web --restart=always -v /opt/data/nginx/www:/usr/share/nginx/html -v /opt/data/nginx/conf/nginx.conf:/etc/nginx/nginx.conf -v /opt/data/nginx/logs:/var/log/nginx nginx